...
var outputCollection = 'aggregated-in-node-array-map';
  ...
  cursor.toArray()
    .then((result) => {
      ...
      for (var i = 0, l = result.length; i < l; i++) {
        ...
        documents[times.hours].values[times.minutes.i].values[times.seconds.i].values[times.milliseconds] = result[i].v;
      }
