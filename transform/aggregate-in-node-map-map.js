...
var outputCollection = 'aggregated-in-node-map-map';
    ...
    .then((result) => {
      ...
      for (var i = 0, l = result.length; i < l; i++) {
        ...
        if (!documents[times.hours]) {
          documents[times.hours] = {};
          documents[times.hours]._id = times.hours;
        }

        documents[times.hours].options = options;
        documents[times.hours][times.minutes.v] = documents[times.hours][times.minutes.v] || {};
        documents[times.hours][times.minutes.v][times.seconds.v] = documents[times.hours][times.minutes.v][times.seconds.v] || {};
        documents[times.hours][times.minutes.v][times.seconds.v][times.milliseconds] = result[i].v;
      }
